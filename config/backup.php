...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             * ],
             *
             * For a complete list of available customization options, see the db-dumper package documentation.
             */
            'databases' => [
         ...
         * See the db-dumper package documentation for compression options.
         *
